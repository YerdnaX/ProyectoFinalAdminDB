(function () {
  ...
  async function cargar(page) {
    ...
    try {
      ...
      if (!items.length) {
        tbody.innerHTML = '<tr><td colspan="8" style="text-align:center;padding:2rem;color:var(--gris-suave);">No se encontraron matrículas.</td></tr>';
        return;
      }
      ...
      tbody.innerHTML = `<tr><td colspan="8" style="text-align:center;padding:2rem;color:var(--rojo-peligro);">Error al cargar matrículas.</td></tr>`;
    }
  }
